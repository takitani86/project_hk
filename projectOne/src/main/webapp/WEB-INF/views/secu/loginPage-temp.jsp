...
<body>
	...
	<div class="container col-md-4 align-content-center">
		<form class="px-4 py-3" action="<c:url value='/user/login'/>"
			method="post">
		...
		<a class="dropdown-item"
			href="<c:url value='/secu/joinMemberForm.do'/>">ProjectOne 회원가입
			하기</a> <a class="dropdown-item"
			href="<c:url value='/secu/joinKakaoMember.do'/>">카카오 계정으로 회원가입 하기</a>
		<a class="dropdown-item"
			href="<c:url value='/secu/to_find_PwForm.do'/>">비밀번호 찾기</a>
	</div>
</body>
</html>

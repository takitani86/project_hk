...
<body class="hold-transition skin-blue-light">
	<div class="wrapper">
		<div class="ground1" style="display:inline-block; width:150px;">
			<img src="../resources/img/product/latte.jpg" class="img-circle" alt="User Image" style="width:80px; height:80px"> <br />
